...
public final class FXRouter {
    ...
    private static final Double WINDOW_WIDTH = 960.0D;
    private static final Double WINDOW_HEIGHT = 540.0D;
    ...
    public static void goTo(String routeLabel) throws IOException {
        ...
        SceneUtility.addAllStyle("default-cursor", "default-style");
        SceneUtility.updateTheme();

        ProgramUtility.closeAllWindows();
    }
